...
\begin{figure}[H]
	...
	\node[draw=none, fill=white!20] (F1) [above=.1cm of F] {5};
	\end{tikzpicture}
	\caption{Heap sort: Step 2. Swapping 12 with 9}
\end{figure}
...
\begin{figure}[H]
	...
	\node[draw=none, fill=white!20] (F1) [above=.1cm of F] {5};
	\end{tikzpicture}
	\caption{Heap sort: Step 4. Swapping 10 with 1}
\end{figure}
...
\begin{figure}[H]
	...
	\node[draw=none, fill=white!20] (F1) [above=.1cm of F] {5};
	\end{tikzpicture}
	\caption{Heap sort: Step 6. Swap 5 with 9}
\end{figure}
...
\begin{figure}[H]	
	...
	\node[draw=none, fill=white!20] (F1) [above=.1cm of F] {5};
	\end{tikzpicture}
	\caption{Heap sort: Step 8. Swap 6 with 1}
\end{figure}
\begin{figure}[H]	
	\centering
	\begin{tikzpicture}[
...
\begin{figure}[H]
	...
	\node[draw=none, fill=white!20] (F1) [above=.1cm of F] {5};
	\end{tikzpicture}
	\caption{Heap sort: Step 10. Swap 5 with 1}
\end{figure}
